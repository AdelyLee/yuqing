      ...
      <el-col v-loading="accidentsLoading">
        ...
        <div style="margin-top: 60px">
          ...
          <ul class="article-list">
            <li class="zdsg-list" :title="item.content" v-for="(item, index) in accidentData">
              <el-row class="lists">
                <div class="border-left-top"></div>
                <div class="border-right-top"></div>
              </el-row>
              ...
              <el-row :gutter="15" style="padding: 20px 20px">
                ...
                <el-col :span="24"class="cont">{{content = item.content && item.content.length < 130 ? item.content :
                ...
                <!--<el-col :span="24" v-if="contentAll === ''" class="cont"><div class="main">{{content = item.content && item.content.length < 130 ? item.content :-->
                  <!--item.content.substring(0, 130)}}<span v-if="item.content.length>130" @click="part(item,index)">...</span></div>-->
                <!--</el-col>-->
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
//      dataDetail: function (index, e) {
//        var x = -100
//        var y = 32
//        $('.article-list').find('li').eq(index).find('.tipTitle').css('display', 'block')
//        if (e.pageY > 300 && e.pageX > 700) {
//          $('.article-list').find('li').eq(index).find('.tipTitle').css({
//            'top': y + 'px',
//            'right': x + 'px'
//          })
//        } else {
...
//        }
//      },
//      hiddenDetail: function (index, e) {
//        $('.article-list').find('li').eq(index).find('.tipTitle').css('display', 'none')
//      },
//      part: function (item, index) {
//        let self = this
//        $('.article-list').find('li').eq(index).css('height', '200px')
//        $('.article-list').find('li').eq(index).find('.main').css('height', '150px')
//        $('.article-list').find('li').eq(index).find('.border-left-bottom').css('top', '164px')
//        $('.article-list').find('li').eq(index).find('.border-right-bottom').css('top', '164px')
