      ...
      <div class="card-body">
          ...
          <el-col :span="12">
            <el-card class="box-card" :body-style="{ padding: '0px' }">
              <div slot="header" class="chart-header">
                <span class="iconfont icon-media"></span><span class="chart-text">主流媒体</span>
              </div>
              <el-col :span="24" v-loading="emotionAnalysisChartLoading">
                <line-bar-chart :chartConfig="emotionAnalysisChartConfig"></line-bar-chart>
              </el-col>
            </el-card>
          </el-col>
        ...
        <el-row :gutter="15">
          <el-col :span="24">
            <el-card class="box-card" :body-style="{ padding: '0px' }">
              <div slot="header" class="chart-header">
                <span class="iconfont icon-emotion"></span><span class="chart-text">载体趋势分析</span>
              </div>
...
<script>
  ...
  import {ARTICLE_TYPE_FOR_NEWS} from '@/service/common'
        ...
        emotionAnalysisChartConfig: {
          ...
          events: {
            'click': function (param) {
              ...
              self.articlesConditions.type = ARTICLE_TYPE_FOR_NEWS.split('@')
              self.getArticles()
            }
          }
        },
    ...
    methods: {
      ...
      getEmotionAnalysisChart () {
        ...
        let params = {
          ...
          type: ARTICLE_TYPE_FOR_NEWS.split('@')
        }
        ...
        getFilterAndGroupBy(params).then(data => {
          ...
          self.emotionAnalysisChartConfig.option = barChartOption.getOption(renderData, chartConfig)
        }).catch(error => {
          self.$confirm(error.message, '错误', {type: 'error'})
        })
      },
